module ApplicationHelper
  ...
  def form_text_field(f, tag, value='')
    render partial: "form_text_field", locals: {f: f, tag: tag, value: value}
  end
  ...
  def form_email_field(f, tag, value='')
    render partial: "form_email_field", locals: {f: f, tag: tag, value: value}
  end
  ...
  def form_number_field(f, tag, value='')
    render partial: "form_number_field", locals: {f: f, tag: tag, value: value}
  end
